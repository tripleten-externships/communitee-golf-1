...
export const DropdownContent: React.FC<DropdownContentProps> = ({children, open}) => {
    return (
   HEAD
        <div className={`absolute left-0 top-full mt-2 w-[304px] bg-white rounded-[12px] border border-[#959494] shadow-md z-50 transition-all duration-200 ease-in-out transform 
